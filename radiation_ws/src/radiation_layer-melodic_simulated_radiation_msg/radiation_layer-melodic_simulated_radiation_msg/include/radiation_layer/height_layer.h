#ifndef HEIGHT_LAYER_H_
#define HEIGHT_LAYER_H_
#include <ros/ros.h>
...
#include <radiation_layer/HeightLayerConfig.h>
...
class HeightLayer : public costmap_2d::CostmapLayer //costmap_2d::Layer, public costmap_2d::Costmap2D
{
public:
  HeightLayer();
...
private:
  ...
  void reconfigureCB(radiation_layer::HeightLayerConfig &config, uint32_t level);
  dynamic_reconfigure::Server<radiation_layer::HeightLayerConfig> *dsrv_;

  void sensorCB(const gazebo_radiation_plugins::Simulated_Radiation_Msg& rad_msg); // Callback for incoming radiation messages
  ...
  std::list<gazebo_radiation_plugins::Simulated_Radiation_Msg> sensor_msg_buffer_;
