...
ws_lock = Lock()
dict_msgs = {}
from gazebo_radiation_plugins.msg import Snapshot
...
pub_dict = {}
msg_dict = { 'snapshot' : "gazebo_radiation_plugins/Snapshot"}
def monitor():
...
def main(argv):
	...
	log = '/media/angelo/WorkData/git/radiation_ws_1/src/monitor/log_localisation.txt' 
	actions = {
		'snapshot' : ('log', 1)
	}
	monitor()
